const CHECKLIST = [
  ...
  { done: false, label: "Hero section built" },
  { done: false, label: "Features grid complete" },
  { done: false, label: "Pricing + CTA sections added" },
  { done: false, label: "Footer connected — page launch-ready" },
];

const TECH = ["Next.js 15", "TypeScript", "Tailwind CSS"];
          ...
          >
            ...
            >
              <p
                ...
                style={{ color: "#B0B0B0" }}
              >
                Build a complete landing page — hero, features grid, pricing,
                call-to-action, and footer. Every section must feel
                intentional.{" "}
                <span style={{ color: "#F5C754" }}>
                  Ship something you would not be embarrassed to show.
                </span>
              </p>
            </div>
          </div>
